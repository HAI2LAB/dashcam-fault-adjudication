...
출력: fig3_frames/{영상이름}/ 에 t-1.5s ~ t+1.0s 6장 + 검출 시점 로그
사용: python3 make_fig3_frames.py            # supp_video_list.txt의 경로 전부
      python3 make_fig3_frames.py 영상경로   # 특정 영상 1개
"""
import sys, os, re
import cv2
import numpy as np
...
OUT_ROOT = os.path.expanduser('~/TS_code/fig3_frames')
